...
export default function HostSignInPage() {
  ...
  const accountFields = <><label className="field"><span>Account label</span><input name="userName" autoComplete="username webauthn" maxLength={254} required aria-describedby="account-label-help" /></label><p id="account-label-help" className="privacy-line">An email works, but it is not required. This label helps identify your passkey on your device.</p><label className="field"><span>Display name</span><input name="displayName" autoComplete="name" maxLength={80} required /></label></>;
